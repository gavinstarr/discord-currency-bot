 ...
 function getServerStatus() {
     mcping(settings.ip, settings.port, function(err, res) {
         if (!(typeof err === 'undefined' || err === null)) {
             ...
             client.user.setActivity(serverStatus, { type: 'WATCHING' });
             getDate()
         ...
         serverStatus = 'Online Players: ' + res.players.online + ' / ' + res.players.max;
         getDate()
         client.user.setActivity(serverStatus, { type: 'WATCHING' }).then(presence => console.log(
             chalk.cyan('\[' + cleanDate + '\]:') + chalk.white(serverStatus)
         )).catch(console.error);
     })
 }
